...
public class MainActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        flickrRecycleViewAdapter = new FlickrRecycleViewAdapter(MainActivity.this, new ArrayList<Photo>());
        mRecyclerView.setAdapter(flickrRecycleViewAdapter);

        mRecyclerView.addOnItemTouchListener(new RecyclerItemClickListner(this, mRecyclerView, new RecyclerItemClickListner.OnItemClickListener() {
            @Override
...
//                Toast.makeText(MainActivity.this, "Long tap", Toast.LENGTH_SHORT).show();
                ...
                intent.putExtra(PHOTO_TRANSER, flickrRecycleViewAdapter.getPhoto(position));
